...
export class ArbitrationPolicySpEventClient {
  ...
  constructor(rpcClient: PublicClient, address?: Address) {
    this.address =
      address || getAddress(arbitrationPolicySpAddress, rpcClient.chain?.id)
    this.rpcClient = rpcClient
  }
  ...
  public watchAuthorityUpdatedEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<ArbitrationPolicySpAuthorityUpdatedEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: arbitrationPolicySpAbi,
  ...
  public watchInitializedEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<ArbitrationPolicySpInitializedEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: arbitrationPolicySpAbi,
  ...
  public watchUpgradedEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<ArbitrationPolicySpUpgradedEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: arbitrationPolicySpAbi,
