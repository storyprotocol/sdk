...
export const groupingModuleAbi = [
  ...
  },
  {
    ...
    name: 'GROUP_NFT',
    outputs: [
      { name: '', internalType: 'contract IGroupNFT', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
...
export const groupingWorkflowsAbi = [
  ...
  },
  {
    ...
    outputs: [
      { name: '', internalType: 'contract IGroupingModule', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
...
export const ipAssetRegistryAbi = [
  ...
  },
  {
    ...
    outputs: [
      { name: 'results', internalType: 'address[]', type: 'address[]' },
    ],
    stateMutability: 'view',
  },
  {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// MockEvenSplitGroupPool
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

/**
 *
 */
export const mockEvenSplitGroupPoolAbi = [
  {
    type: 'error',
    inputs: [{ name: 'target', internalType: 'address', type: 'address' }],
    name: 'AddressEmptyCode',
  ...
  },
  {
    ...
    name: 'ipAddedTime',
    outputs: [{ name: 'addedTime', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'view',
  },
  {
    type: 'function',
    inputs: [
      { name: 'groupId', internalType: 'address', type: 'address' },
      { name: 'tokenId', internalType: 'address', type: 'address' },
      { name: 'ipId', internalType: 'address', type: 'address' },
    ],
    name: 'ipRewardInfo',
    outputs: [
      { name: 'startPoolBalance', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'poolInfo',
    outputs: [
      { name: 'accBalance', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    name: 'totalMemberIPs',
    outputs: [
      { name: 'totalMemberIPs', internalType: 'uint256', type: 'uint256' },
    ],
    stateMutability: 'view',
  },
] as const
 ...
 *
 */
export const mockEvenSplitGroupPoolAddress = {
  1513: '0x69e0D5123bc0539a87a9dDcE82E803575e35cbb4',
} as const

/**
 *
 */
export const mockEvenSplitGroupPoolConfig = {
  address: mockEvenSplitGroupPoolAddress,
  abi: mockEvenSplitGroupPoolAbi,
} as const
...
export const piLicenseTemplateAbi = [
  ...
  },
  {
    ...
    name: 'TERMS_RENDERER',
    outputs: [
      { name: '', internalType: 'contract PILTermsRenderer', type: 'address' },
    ],
    stateMutability: 'view',
  },
  {
...
export const royaltyPolicyLapAbi = [
  ...
  },
  {
    ...
    name: 'onLinkToParents',
    outputs: [
      { name: 'newRoyaltyStackLAP', internalType: 'uint32', type: 'uint32' },
    ],
    stateMutability: 'nonpayable',
  },
  {
...
export const royaltyPolicyLrpAbi = [
  ...
  },
  {
    ...
    name: 'onLinkToParents',
    outputs: [
      { name: 'newRoyaltyStackLRP', internalType: 'uint32', type: 'uint32' },
    ],
    stateMutability: 'nonpayable',
  },
  {
...
export class AccessControllerClient extends AccessControllerEventClient {
   ...
   */
  public setAllPermissionsEncode(
    request: AccessControllerSetAllPermissionsRequest,
  ): EncodedTxData {
    return {
      to: this.address,
...
export class CoreMetadataModuleEventClient {
  ...
  constructor(rpcClient: PublicClient, address?: Address) {
    this.address =
      address || getAddress(coreMetadataModuleAddress, rpcClient.chain?.id)
    this.rpcClient = rpcClient
  }
  ...
  public watchAuthorityUpdatedEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<CoreMetadataModuleAuthorityUpdatedEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: coreMetadataModuleAbi,
  ...
  public watchInitializedEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<CoreMetadataModuleInitializedEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: coreMetadataModuleAbi,
  ...
  public watchMetadataFrozenEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<CoreMetadataModuleMetadataFrozenEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: coreMetadataModuleAbi,
  ...
  public watchMetadataUriSetEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<CoreMetadataModuleMetadataUriSetEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: coreMetadataModuleAbi,
  ...
  public watchNftTokenUriSetEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<CoreMetadataModuleNftTokenUriSetEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: coreMetadataModuleAbi,
...
export class CoreMetadataModuleClient extends CoreMetadataModuleReadOnlyClient {
   ...
   */
  public async setAll(
    request: CoreMetadataModuleSetAllRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: coreMetadataModuleAbi,
      address: this.address,
...
export class DerivativeWorkflowsClient {
  ...
  constructor(
    ...
    this.address =
      address || getAddress(derivativeWorkflowsAddress, rpcClient.chain?.id)
    this.rpcClient = rpcClient
    this.wallet = wallet
  }
...
export class GroupingModuleEventClient {
  ...
  public watchAddedIpToGroupEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<GroupingModuleAddedIpToGroupEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: groupingModuleAbi,
  ...
  public watchAuthorityUpdatedEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<GroupingModuleAuthorityUpdatedEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: groupingModuleAbi,
  ...
  public watchIpGroupRegisteredEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<GroupingModuleIpGroupRegisteredEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: groupingModuleAbi,
   ...
   */
  public parseTxPausedEvent(
    txReceipt: TransactionReceipt,
  ): Array<GroupingModulePausedEvent> {
  ...
  public watchRemovedIpFromGroupEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<GroupingModuleRemovedIpFromGroupEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: groupingModuleAbi,
  ...
  public parseTxUnpausedEvent(
    txReceipt: TransactionReceipt,
  ): Array<GroupingModuleUnpausedEvent> {
  ...
  public parseTxUpgradedEvent(
    txReceipt: TransactionReceipt,
  ): Array<GroupingModuleUpgradedEvent> {
...
export class GroupingModuleClient extends GroupingModuleReadOnlyClient {
   ...
   */
  public async addIp(
    request: GroupingModuleAddIpRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: groupingModuleAbi,
      address: this.address,
  ...
  public async removeIp(
    request: GroupingModuleRemoveIpRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: groupingModuleAbi,
      address: this.address,
...
export class GroupingWorkflowsClient {
  ...
  constructor(
    ...
    this.address =
      address || getAddress(groupingWorkflowsAddress, rpcClient.chain?.id)
    this.rpcClient = rpcClient
    this.wallet = wallet
  }
...
export class IpAssetRegistryEventClient {
  ...
  public watchIpAccountRegisteredEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<IpAssetRegistryIpAccountRegisteredEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: ipAssetRegistryAbi,
...
export class LicenseAttachmentWorkflowsClient {
  ...
  constructor(
    ...
    this.address =
      address ||
      getAddress(licenseAttachmentWorkflowsAddress, rpcClient.chain?.id)
    this.rpcClient = rpcClient
    this.wallet = wallet
  }
...
export class LicenseRegistryEventClient {
  ...
  public watchDefaultLicenseTermsSetEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<LicenseRegistryDefaultLicenseTermsSetEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: licenseRegistryAbi,
...
export class LicensingModuleEventClient {
  ...
  public watchLicenseTermsAttachedEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<LicensingModuleLicenseTermsAttachedEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: licensingModuleAbi,
...
export class LicensingModuleClient extends LicensingModuleReadOnlyClient {
   ...
   * @return EncodedTxData
   */
  public mintLicenseTokensEncode(
    request: LicensingModuleMintLicenseTokensRequest,
  ): EncodedTxData {
    return {
      to: this.address,
...
/**
 * MockEvenSplitGroupPoolGetAvailableRewardRequest
 *
 * @param groupId address
 * @param token address
 * @param ipIds address[]
 */
export type MockEvenSplitGroupPoolGetAvailableRewardRequest = {
  groupId: Address
  token: Address
  ipIds: readonly Address[]
}

export type MockEvenSplitGroupPoolGetAvailableRewardResponse = readonly bigint[]

/**
 * MockEvenSplitGroupPoolIpAddedTimeRequest
 *
 * @param groupId address
 * @param ipId address
 */
export type MockEvenSplitGroupPoolIpAddedTimeRequest = {
  groupId: Address
  ipId: Address
}

/**
 * MockEvenSplitGroupPoolIpAddedTimeResponse
 *
 * @param addedTime uint256
 */
export type MockEvenSplitGroupPoolIpAddedTimeResponse = {
  addedTime: bigint
}

/**
 * MockEvenSplitGroupPoolIpRewardInfoRequest
 *
 * @param groupId address
 * @param tokenId address
 * @param ipId address
 */
export type MockEvenSplitGroupPoolIpRewardInfoRequest = {
  groupId: Address
  tokenId: Address
  ipId: Address
}
...
/**
 * MockEvenSplitGroupPoolIpRewardInfoResponse
 *
 * @param startPoolBalance uint256
 * @param rewardDebt uint256
 */
export type MockEvenSplitGroupPoolIpRewardInfoResponse = {
  startPoolBalance: bigint
  rewardDebt: bigint
}

/**
 * MockEvenSplitGroupPoolPoolInfoRequest
 *
 * @param groupId address
 * @param token address
 */
export type MockEvenSplitGroupPoolPoolInfoRequest = {
  groupId: Address
  token: Address
}

/**
 * MockEvenSplitGroupPoolPoolInfoResponse
 *
 * @param accBalance uint256
 * @param availableBalance uint256
 */
export type MockEvenSplitGroupPoolPoolInfoResponse = {
  accBalance: bigint
  availableBalance: bigint
}

/**
 * MockEvenSplitGroupPoolTotalMemberIPsRequest
 *
 * @param groupId address
 */
export type MockEvenSplitGroupPoolTotalMemberIPsRequest = {
  groupId: Address
}

/**
 * MockEvenSplitGroupPoolTotalMemberIPsResponse
 *
 * @param totalMemberIPs uint256
 */
export type MockEvenSplitGroupPoolTotalMemberIPsResponse = {
  totalMemberIPs: bigint
}

/**
 * MockEvenSplitGroupPoolAddIpRequest
 *
 * @param groupId address
 * @param ipId address
 */
export type MockEvenSplitGroupPoolAddIpRequest = {
  groupId: Address
  ipId: Address
}

/**
 * MockEvenSplitGroupPoolCollectRoyaltiesRequest
 *
 * @param groupId address
 * @param token address
 */
export type MockEvenSplitGroupPoolCollectRoyaltiesRequest = {
  groupId: Address
  token: Address
}

/**
 * MockEvenSplitGroupPoolDepositRewardRequest
 *
 * @param groupId address
 * @param token address
 * @param amount uint256
 */
export type MockEvenSplitGroupPoolDepositRewardRequest = {
  groupId: Address
  token: Address
  amount: bigint
}
...
/**
 * MockEvenSplitGroupPoolDistributeRewardsRequest
 *
 * @param groupId address
 * @param token address
 * @param ipIds address[]
 */
export type MockEvenSplitGroupPoolDistributeRewardsRequest = {
  groupId: Address
  token: Address
  ipIds: readonly Address[]
}
...
/**
 * MockEvenSplitGroupPoolRemoveIpRequest
 *
 * @param groupId address
 * @param ipId address
 */
export type MockEvenSplitGroupPoolRemoveIpRequest = {
  groupId: Address
  ipId: Address
}

/**
 * contract MockEvenSplitGroupPool readonly method
 */
export class MockEvenSplitGroupPoolReadOnlyClient {
  protected readonly rpcClient: PublicClient
  public readonly address: Address

  constructor(rpcClient: PublicClient, address?: Address) {
    this.address =
      address || getAddress(mockEvenSplitGroupPoolAddress, rpcClient.chain?.id)
    this.rpcClient = rpcClient
  }

  /**
   * method getAvailableReward for contract MockEvenSplitGroupPool
   *
   * @param request MockEvenSplitGroupPoolGetAvailableRewardRequest
   * @return Promise<MockEvenSplitGroupPoolGetAvailableRewardResponse>
   */
  public async getAvailableReward(
    request: MockEvenSplitGroupPoolGetAvailableRewardRequest,
  ): Promise<MockEvenSplitGroupPoolGetAvailableRewardResponse> {
    return await this.rpcClient.readContract({
      abi: mockEvenSplitGroupPoolAbi,
      address: this.address,
  ...
  /**
   * method ipAddedTime for contract MockEvenSplitGroupPool
   *
   * @param request MockEvenSplitGroupPoolIpAddedTimeRequest
   * @return Promise<MockEvenSplitGroupPoolIpAddedTimeResponse>
   */
  public async ipAddedTime(
    request: MockEvenSplitGroupPoolIpAddedTimeRequest,
  ): Promise<MockEvenSplitGroupPoolIpAddedTimeResponse> {
    const result = await this.rpcClient.readContract({
      abi: mockEvenSplitGroupPoolAbi,
      address: this.address,
      functionName: 'ipAddedTime',
  ...
  /**
   * method ipRewardInfo for contract MockEvenSplitGroupPool
   *
   * @param request MockEvenSplitGroupPoolIpRewardInfoRequest
   * @return Promise<MockEvenSplitGroupPoolIpRewardInfoResponse>
   */
  public async ipRewardInfo(
    request: MockEvenSplitGroupPoolIpRewardInfoRequest,
  ): Promise<MockEvenSplitGroupPoolIpRewardInfoResponse> {
    const result = await this.rpcClient.readContract({
      abi: mockEvenSplitGroupPoolAbi,
      address: this.address,
      functionName: 'ipRewardInfo',
      args: [request.groupId, request.tokenId, request.ipId],
    })
    return {
      startPoolBalance: result[0],
      rewardDebt: result[1],
    }
  }

  /**
   * method poolInfo for contract MockEvenSplitGroupPool
   *
   * @param request MockEvenSplitGroupPoolPoolInfoRequest
   * @return Promise<MockEvenSplitGroupPoolPoolInfoResponse>
   */
  public async poolInfo(
    request: MockEvenSplitGroupPoolPoolInfoRequest,
  ): Promise<MockEvenSplitGroupPoolPoolInfoResponse> {
    const result = await this.rpcClient.readContract({
      abi: mockEvenSplitGroupPoolAbi,
      address: this.address,
  ...
  /**
   * method totalMemberIPs for contract MockEvenSplitGroupPool
   *
   * @param request MockEvenSplitGroupPoolTotalMemberIPsRequest
   * @return Promise<MockEvenSplitGroupPoolTotalMemberIPsResponse>
   */
  public async totalMemberIPs(
    request: MockEvenSplitGroupPoolTotalMemberIPsRequest,
  ): Promise<MockEvenSplitGroupPoolTotalMemberIPsResponse> {
    const result = await this.rpcClient.readContract({
      abi: mockEvenSplitGroupPoolAbi,
      address: this.address,
      functionName: 'totalMemberIPs',
      args: [request.groupId],
    })
    return {
      totalMemberIPs: result,
    }
  }
}

/**
 * contract MockEvenSplitGroupPool write method
 */
export class MockEvenSplitGroupPoolClient extends MockEvenSplitGroupPoolReadOnlyClient {
  protected readonly wallet: SimpleWalletClient
  ...
  /**
   * method addIp for contract MockEvenSplitGroupPool
   *
   * @param request MockEvenSplitGroupPoolAddIpRequest
   * @return Promise<WriteContractReturnType>
   */
  public async addIp(
    request: MockEvenSplitGroupPoolAddIpRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: mockEvenSplitGroupPoolAbi,
      address: this.address,
  ...
  /**
   * method addIp for contract MockEvenSplitGroupPool with only encode
   *
   * @param request MockEvenSplitGroupPoolAddIpRequest
   * @return EncodedTxData
   */
  ...
  /**
   * method collectRoyalties for contract MockEvenSplitGroupPool
   *
   * @param request MockEvenSplitGroupPoolCollectRoyaltiesRequest
   * @return Promise<WriteContractReturnType>
   */
  public async collectRoyalties(
    request: MockEvenSplitGroupPoolCollectRoyaltiesRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: mockEvenSplitGroupPoolAbi,
      address: this.address,
  ...
  /**
   * method collectRoyalties for contract MockEvenSplitGroupPool with only encode
   *
   * @param request MockEvenSplitGroupPoolCollectRoyaltiesRequest
   * @return EncodedTxData
   */
  public collectRoyaltiesEncode(
    request: MockEvenSplitGroupPoolCollectRoyaltiesRequest,
  ): EncodedTxData {
    return {
      to: this.address,
  ...
  /**
   * method depositReward for contract MockEvenSplitGroupPool
   *
   * @param request MockEvenSplitGroupPoolDepositRewardRequest
   * @return Promise<WriteContractReturnType>
   */
  public async depositReward(
    request: MockEvenSplitGroupPoolDepositRewardRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: mockEvenSplitGroupPoolAbi,
      address: this.address,
  ...
  /**
   * method depositReward for contract MockEvenSplitGroupPool with only encode
   *
   * @param request MockEvenSplitGroupPoolDepositRewardRequest
   * @return EncodedTxData
   */
  public depositRewardEncode(
    request: MockEvenSplitGroupPoolDepositRewardRequest,
  ): EncodedTxData {
    return {
      to: this.address,
  ...
  /**
   * method distributeRewards for contract MockEvenSplitGroupPool
   *
   * @param request MockEvenSplitGroupPoolDistributeRewardsRequest
   * @return Promise<WriteContractReturnType>
   */
  public async distributeRewards(
    request: MockEvenSplitGroupPoolDistributeRewardsRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: mockEvenSplitGroupPoolAbi,
      address: this.address,
  ...
  /**
   * method distributeRewards for contract MockEvenSplitGroupPool with only encode
   *
   * @param request MockEvenSplitGroupPoolDistributeRewardsRequest
   * @return EncodedTxData
   */
  ...
  /**
   * method removeIp for contract MockEvenSplitGroupPool
   *
   * @param request MockEvenSplitGroupPoolRemoveIpRequest
   * @return Promise<WriteContractReturnType>
   */
  public async removeIp(
    request: MockEvenSplitGroupPoolRemoveIpRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: mockEvenSplitGroupPoolAbi,
      address: this.address,
  ...
  /**
   * method removeIp for contract MockEvenSplitGroupPool with only encode
   *
   * @param request MockEvenSplitGroupPoolRemoveIpRequest
   * @return EncodedTxData
   */
  public removeIpEncode(
    request: MockEvenSplitGroupPoolRemoveIpRequest,
  ): EncodedTxData {
    return {
      to: this.address,
...
export class RegistrationWorkflowsEventClient {
  ...
  constructor(rpcClient: PublicClient, address?: Address) {
    this.address =
      address || getAddress(registrationWorkflowsAddress, rpcClient.chain?.id)
    this.rpcClient = rpcClient
  }
  ...
  public watchCollectionCreatedEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<RegistrationWorkflowsCollectionCreatedEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: registrationWorkflowsAbi,
 ...
 * @param 2 bytes
 */
export type RoyaltyPolicyLrpOnLicenseMintingRequest = readonly [
  Address,
  number,
  Hex,
]
...
export class RoyaltyPolicyLrpEventClient {
  ...
  constructor(rpcClient: PublicClient, address?: Address) {
    this.address =
      address || getAddress(royaltyPolicyLrpAddress, rpcClient.chain?.id)
    this.rpcClient = rpcClient
  }
  ...
  public watchAuthorityUpdatedEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<RoyaltyPolicyLrpAuthorityUpdatedEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: royaltyPolicyLrpAbi,
  ...
  public watchInitializedEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<RoyaltyPolicyLrpInitializedEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: royaltyPolicyLrpAbi,
  ...
  public parseTxPausedEvent(
    txReceipt: TransactionReceipt,
  ): Array<RoyaltyPolicyLrpPausedEvent> {
  ...
  public watchRevenueTransferredToVaultEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<RoyaltyPolicyLrpRevenueTransferredToVaultEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: royaltyPolicyLrpAbi,
  ...
  public parseTxUnpausedEvent(
    txReceipt: TransactionReceipt,
  ): Array<RoyaltyPolicyLrpUnpausedEvent> {
  ...
  public parseTxUpgradedEvent(
    txReceipt: TransactionReceipt,
  ): Array<RoyaltyPolicyLrpUpgradedEvent> {
...
export class RoyaltyWorkflowsClient {
  ...
  constructor(
    ...
    this.address =
      address || getAddress(royaltyWorkflowsAddress, rpcClient.chain?.id)
    this.rpcClient = rpcClient
    this.wallet = wallet
  }
...
export class SpgnftBeaconClient extends SpgnftBeaconReadOnlyClient {
   ...
   * @return EncodedTxData
   */
  public transferOwnershipEncode(
    request: SpgnftBeaconTransferOwnershipRequest,
  ): EncodedTxData {
    return {
      to: this.address,
...
export class SpgnftImplEventClient {
  ...
  public watchBatchMetadataUpdateEvent(
    onLogs: (
      txHash: Hex,
      ev: Partial<SpgnftImplBatchMetadataUpdateEvent>,
    ) => void,
  ): WatchContractEventReturnType {
    return this.rpcClient.watchContractEvent({
      abi: spgnftImplAbi,
...
export class SpgnftImplClient extends SpgnftImplReadOnlyClient {
   ...
   * @return EncodedTxData
   */
  public safeTransferFrom2Encode(
    request: SpgnftImplSafeTransferFrom2Request,
  ): EncodedTxData {
    return {
      to: this.address,
   ...
   * @return EncodedTxData
   */
  public setApprovalForAllEncode(
    request: SpgnftImplSetApprovalForAllRequest,
  ): EncodedTxData {
    return {
      to: this.address,
  ...
  public async setBaseUri(
    request: SpgnftImplSetBaseUriRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: spgnftImplAbi,
      address: this.address,
  ...
  public async setMintFee(
    request: SpgnftImplSetMintFeeRequest,
  ): Promise<WriteContractReturnType> {
    const { request: call } = await this.rpcClient.simulateContract({
      abi: spgnftImplAbi,
      address: this.address,
   ...
   * @return EncodedTxData
   */
  public setMintFeeRecipientEncode(
    request: SpgnftImplSetMintFeeRecipientRequest,
  ): EncodedTxData {
    return {
      to: this.address,
