...
export const ipAssetRegistryAddress =
  '0x980d2c331E8fD31D7397d83AA9Bba44EaA4daeBC' as const
 ...
 */
export const useWatchIpAssetRegistry =
 ...
 */
export const useWatchIpAssetRegistryApprovalForAll =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: ipAssetRegistryAbi,
    address: ipAssetRegistryAddress,
 ...
 */
export const useWatchIpAssetRegistryGovernanceUpdated =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: ipAssetRegistryAbi,
    address: ipAssetRegistryAddress,
 ...
 */
export const useWatchIpAssetRegistryIpAccountRegistered =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: ipAssetRegistryAbi,
    address: ipAssetRegistryAddress,
 ...
 */
export const useWatchIpAssetRegistryIpRegistered =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: ipAssetRegistryAbi,
    address: ipAssetRegistryAddress,
 ...
 */
export const useWatchIpAssetRegistryIpResolverSet =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: ipAssetRegistryAbi,
    address: ipAssetRegistryAddress,
 ...
 */
export const useWatchIpAssetRegistryMetadataSet =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: ipAssetRegistryAbi,
    address: ipAssetRegistryAddress,
