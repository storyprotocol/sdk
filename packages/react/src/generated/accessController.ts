...
export const accessControllerAddress =
  '0x069AD174fb6285086b692AC9a6f328DCBcB94FC3' as const
 ...
 */
export const useReadAccessControllerIpAccountRegistry =
 ...
 */
export const useReadAccessControllerModuleRegistry =
  /*#__PURE__*/ createUseReadContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useReadAccessControllerCheckPermission =
  /*#__PURE__*/ createUseReadContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useReadAccessControllerGetGovernance =
  /*#__PURE__*/ createUseReadContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useReadAccessControllerGetPermission =
  /*#__PURE__*/ createUseReadContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useReadAccessControllerGovernance =
  /*#__PURE__*/ createUseReadContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useReadAccessControllerPermissions =
  /*#__PURE__*/ createUseReadContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useWriteAccessControllerInitialize =
 ...
 */
export const useWriteAccessControllerSetBatchPermissions =
  /*#__PURE__*/ createUseWriteContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useWriteAccessControllerSetGlobalPermission =
  /*#__PURE__*/ createUseWriteContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useWriteAccessControllerSetGovernance =
  /*#__PURE__*/ createUseWriteContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useWriteAccessControllerSetPermission =
  /*#__PURE__*/ createUseWriteContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useSimulateAccessControllerInitialize =
  /*#__PURE__*/ createUseSimulateContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
    functionName: 'initialize',
 ...
 */
export const useSimulateAccessControllerSetGovernance =
  /*#__PURE__*/ createUseSimulateContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
    functionName: 'setGovernance',
 ...
 */
export const useSimulateAccessControllerSetPermission =
  /*#__PURE__*/ createUseSimulateContract({
    abi: accessControllerAbi,
    address: accessControllerAddress,
    functionName: 'setPermission',
 ...
 */
export const useWatchAccessControllerEvent =
 ...
 */
export const useWatchAccessControllerGovernanceUpdatedEvent =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: accessControllerAbi,
    address: accessControllerAddress,
 ...
 */
export const useWatchAccessControllerPermissionSetEvent =
  /*#__PURE__*/ createUseWatchContractEvent({
    abi: accessControllerAbi,
    address: accessControllerAddress,
